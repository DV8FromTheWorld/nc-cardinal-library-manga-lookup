              ...
              {volume.availability.totalCopies === 0 && volume.catalogUrl != null ? (
                <div className={styles.availabilitySummary}>
                  <div className={`${styles.availabilityStatus} ${styles.digitalOnly}`}>
                    ...
                    <Text variant="text-lg/semibold">Digital Only</Text>
                  </div>
                  <Text
                    variant="text-md/normal"
                    color="text-secondary"
                ...
                <div className={styles.availabilitySummary}>
                  <div
                    className={`${styles.availabilityStatus} ${volume.availability.available ? styles.available : styles.unavailable}`}
                  >
                  ...
                  <div className={styles.copyCount}>
                    <Text variant="header-lg/bold" className={styles.copyNumber}>
                      {volume.availability.availableCopies}
                    </Text>
                    <Text
                      variant="text-md/normal"
                      color="text-secondary"
                  ...
                  {volume.availability.localCopies !== undefined && (
                    <div className={styles.localRemote}>
                      <div className={styles.localStatus}>
                        <span
                          className={`${styles.localDot} ${(volume.availability.localAvailable ?? 0) > 0 ? styles.available : styles.unavailable}`}
                        />
                      ...
                      <div key={libraryName} className={styles.libraryItem}>
                        ...
                        <div className={styles.libraryCopies}>
                          <Text
                            ...
                            className={`${styles.copyBadge} ${availableCount > 0 ? styles.available : styles.unavailable}`}
                          >
