...
export function DebugPanel({
  ...
  return (
    <View
      style={[styles.container, { backgroundColor: theme.bgSecondary, borderColor: theme.border }]}
    >
      <TouchableOpacity
            ...
            <ScrollView style={styles.debugContent} showsVerticalScrollIndicator={false}>
              ...
              {debug.dataIssues != null && debug.dataIssues.length > 0 && (
                <View style={styles.section}>
                  <Text variant="text-sm/semibold" color="warning">
                    ⚠️ Data Issues
                  </Text>
              ...
              {debug.sourceSummary != null && (
                <View style={styles.section}>
                  <Text variant="text-sm/semibold" color="text-primary">
                    Source Summary
                  </Text>
                  {debug.sourceSummary.wikipedia != null && (
                    <View
                      style={[
                        styles.sourceCard,
                        {
                          backgroundColor: debug.sourceSummary.wikipedia.found
                            ? theme.successBg
                            : theme.errorBg,
                        },
                      ]}
                    >
                      ...
                      <Text
                        variant="text-xs/normal"
                        color={debug.sourceSummary.wikipedia.found ? 'success' : 'error'}
                  ...
                  {debug.sourceSummary.googleBooks != null && (
                    <View
                      style={[
                        styles.sourceCard,
                        {
                          backgroundColor: debug.sourceSummary.googleBooks.found
                            ? theme.successBg
                            : theme.errorBg,
                        },
                      ]}
                    >
                      ...
                      <Text
                        variant="text-xs/normal"
                        color={debug.sourceSummary.googleBooks.found ? 'success' : 'error'}
                        style={styles.sourceValue}
                      >
                  ...
                  {debug.sourceSummary.ncCardinal != null && (
                    <View
                      style={[
                        styles.sourceCard,
                        {
                          backgroundColor: debug.sourceSummary.ncCardinal.found
                            ? theme.successBg
                            : theme.errorBg,
                        },
                      ]}
                    >
                      ...
                      <Text
                        variant="text-xs/normal"
                        color={debug.sourceSummary.ncCardinal.found ? 'success' : 'error'}
                        style={styles.sourceValue}
                      >
              ...
              <View style={styles.section}>
                ...
                <View style={styles.timingGrid}>
                  ...
                  {debug.timing.googleBooks !== undefined && (
                    <TimingItem
                      label="Google Books"
                      value={debug.timing.googleBooks}
                      theme={theme}
                    />
                  )}
                ...
                <View style={styles.section}>
                  ...
                  <View style={styles.tagsContainer}>
                    {debug.cacheHits.map((hit, i) => (
                      ...
                      <View
                        key={`${hit}-${i}`}
                        style={[styles.tag, { backgroundColor: theme.successBg }]}
                      >
                        <Text variant="text-xs/normal" color="success">
                          {hit}
                        </Text>
                      </View>
                    ))}
              ...
              {debug.errors.length > 0 && (
                <View style={styles.section}>
                  <Text variant="text-sm/semibold" color="error">
                    🚨 Errors
                  </Text>
              ...
              {debug.warnings.length > 0 && (
                <View style={styles.section}>
                  <Text variant="text-sm/semibold" color="text-secondary">
                    Warnings
                  </Text>
